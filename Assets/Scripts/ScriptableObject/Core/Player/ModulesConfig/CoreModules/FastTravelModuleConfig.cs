...
[CreateAssetMenu(fileName = "FastTravelConfig", menuName = "Scriptable Objects/FastTravelConfig")]
public class FastTravelModuleConfig : BaseModuleConfig
{
    ...
    public override Type GetModuleType() => typeof(FastTravelModule);
