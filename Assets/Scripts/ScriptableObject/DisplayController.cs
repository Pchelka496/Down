...
public class DisplayControllerConfig : ScriptableObject
{
    ...
    public string SetClimbingMode { get => _setClimbingMode; }
    public string SetDescendingMode { get => _setDescendingMode; }
