...
public class FastTravelModuleController : MonoBehaviour, IUIPanel
{
    [SerializeField] CustomPressButton _startFastTravelMoving;
    ...
    FastTravelModule _module;
    FastTravelModuleConfig _moduleConfig;
    ...
    private void Construct(CameraFacade cameraFacade,
                           FastTravelModuleConfig moduleConfig,
                           ...
                           GlobalEventsManager globalEventsManager)
    {
        ...
        _module = player.FastTravelModule;
    }

    private async void Start()
    {
        _startFastTravelMoving.onClick.AddListener(StartWarpMoving);
    ...
    private async void StartWarpMoving()
    {
        ...
        await _module.PreparationForMoving();
